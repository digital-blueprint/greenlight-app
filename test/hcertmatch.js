...
suite('matchPerson', () => {
    test('basic', () => {
        ...
        assert.isTrue(checkPerson("", "", "ISOLDE<ERIKA","MUSTERFRAU<GOESSINGER<MUELLER", "", "Isolde Erika", "Musterfrau-Gößinger Müller", ""));
        assert.isTrue(checkPerson("ابو بكر محمد", "بن زكريا الرازي", "ABU<BAKR<MOHAMMED", "IBN<ZAKARIA<AL<RAZI", "", "Abu-Bakr Mohammed", "Ibn Zakaria al-Razi", ""));
        assert.isTrue(checkPerson("ابو بكر محمد", "بن زكريا الرازي", "ABU<BAKR<MOHAMMED", "IBN<ZAKARIA<AL<RAZI", "", "Abu Bakr Mohammed", "Ibn Zakaria al Razi", ""));
