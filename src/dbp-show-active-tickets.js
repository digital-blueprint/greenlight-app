    ...
    render() {
        ...
        return html`
            ...
            <div class="control ${classMap({hidden: this.isLoggedIn() || !this.isLoading()})}">
                <span class="loading">
                    <dbp-mini-spinner text=${i18n.t('show-active-tickets.loading-message')}></dbp-mini-spinner>
                </span>
            </div>
            ...
            <div class="${classMap({hidden: !this.isLoggedIn() || this.isLoading()})}">
                ...
                <div>
                    <p class="">${i18n.t('show-active-tickets.description')}</p>
                    <slot name="additional-information">
                        <p>${i18n.t('show-active-tickets.additional-information')}</p>
                    </slot>
                </div>
            </div>
        `;
